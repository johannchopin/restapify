...
it('should get correct served routes', () => {
  ...
  const expectedServedRoutesAmount = 23
  const expectedServedRoutesResponse = [{ "method": "GET", "route": "/animals" }, { "method": "GET", "route": "/animals/[name]" }, { "method": "GET", "route": "/animals/[name]/friends" }, { "method": "GET", "route": "/animals/[name]/friends/[friend_id]" }, { "method": "GET", "route": "/animals/hedgehog" }, { "method": "GET", "route": "/animals/pets" }, { "method": "GET", "route": "/cars" }, { "method": "GET", "route": "/comments" }, { "method": "GET", "route": "/comments/42" }, { "method": "GET", "route": "/comments/43" }, { "method": "GET", "route": "/comments/[id]" }, { "method": "GET", "route": "/plants" }, { "method": "GET", "route": "/posts" }, { "method": "GET", "route": "/posts/[postid]" }, { "method": "GET", "route": "/posts/[postid]/comments/[commentid]" }, { "method": "POST", "route": "/posts/[postid]/private/[isPrivate]" }, { "method": "GET", "route": "/users" }, { "method": "POST", "route": "/users" }, { "method": "GET", "route": "/users/[userid]" }, { "method": "PUT", "route": "/users/[userid]" }, { "method": "PATCH", "route": "/users/[userid]" }, { "method": "DELETE", "route": "/users/[userid]" }, { "method": "GET", "route": "/users/[userid]/friends" }]
